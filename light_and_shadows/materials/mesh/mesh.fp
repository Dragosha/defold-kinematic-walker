...
void main()
{
    ...
    // vec3 normal_sum = get_normal();
    // vec3 normal_sum = get_normal2(); // - full normal calculation
    vec3 normal_sum = var_normal;

//     //
//     highp vec3 view_vec = var_position.xyz - cam_pos.xyz;
//     highp float distance = length(view_vec);
//     highp vec3 view_normalized = view_vec/distance;
// 
//     highp vec3 real_normal = var_normal;
//     float RNdotV = dot(real_normal, -view_normalized);
//     if (RNdotV<0.0)
//     {
//         highp vec3 cross_normal = cross(real_normal, -view_normalized);
//         real_normal = normalize( cross(cross_normal, -view_normalized) );
//         if (dot(var_normal, real_normal)<0.0) real_normal = -real_normal;
//     }
//     normal_sum = real_normal;
//     //
